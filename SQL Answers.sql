-- Q15) Identify the top 5 doctors who generated the most revenue but had the fewest patients.
...
-- Q16) Find the department where the average waiting time has decreased over three consecutive months.
with cte as
...
-- Q17) Determine the ratio of male to female patients for each doctor and rank the doctors based on this ratio.
with cte as 
...
-- Q18)  Calculate the average satisfaction score of patients for each doctor based on their visits.
select d.`Doctor Name` as Doctor_Name,
...
-- Q19) Find doctors who have treated patients from different races and calculate the diversity of their patient base.
select d.`Doctor Name` as Doctor_Name,
...
-- Q20) Calculate the ratio of total bills generated by male patients to female patients for each department.
...
-- Q21) Update the patient satisfaction score for all patients who visited the "General Practice" department and had a waiting time of more than 30 minutes. Increase their satisfaction score by 2 points, but ensure that the satisfaction score does not exceed 10.
update hospital
